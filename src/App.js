  ...
  return (
    <div className="App bg-gray-100 p-6">
      <nav className="flex justify-between capitalize text-2xl text-center mb-4 font-bold">
        <button
          className={`px-4 py-2 text-sm font-semibold text-indigo-700 transition-all ease-linear duration-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50 ${
